...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.6.1-green.svg" alt="Version Badge">
...
**Framework Version**: 2.6.1 (2026-07-29) | **Python**: 3.14 | **License**: MIT
...
| [Changelog & Release History](CHANGELOG.md) | Version history, fixes, and breaking changes (v2.6.1 current) |
...
**Status**: Production / Stable (v2.6.1)
**Python**: 3.14+ | **License**: MIT | **Maintainer**: [@darshil0](https://github.com/darshil0)

**Last Updated**: 2026-07-29 | **Next Release**: TBD
