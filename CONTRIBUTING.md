...
3. **Local Verification**: Run `make lint` and `make test` to ensure your code passes all checks before pushing.
...
> 4. **Quality**: Adhere to the strict type hints, detailed docstrings, and robust input validation.
> 
> 
...
*By reverse-engineering the intent behind the framework, developers can better understand the logic behind the code structure.*
